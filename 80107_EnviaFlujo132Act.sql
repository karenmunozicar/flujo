...
insert into isys_querys_tx values ('80107',10,1,19,'Envia a Procesar a Procesador ACT',180106,0,0,0,0,15,15);

--Log especifico
insert into isys_querys_tx values ('80107',15,1,16,'["TX","__COLA_MOTOR__","__ID_DTE__","__STS_ERROR_SOCKET__","__TIME_TX__","STATUS","__PROC_ACTIVOS__","CATEGORIA","SUB_CATEGORIA"]',0,0,0,1,1,0,0);
