--Publica documento
delete from isys_querys_tx where llave='12704';
--insert into isys_querys_tx values ('12704',10,1,1,'select proc_procesa_publica_dte_12704(''$$__XMLCOMPLETO__$$'') as __xml__',0,0,0,1,1,-1,0);
--insert into isys_querys_tx values ('12704',20,1,2,'Llamada al Storage Writer',4010,104,105,0,0,30,30);
--insert into isys_querys_tx values ('12704',30,1,1,'select proc_procesa_publica_dte_respuesta_12704(''$$__XMLCOMPLETO__$$'') as __xml__',0,0,0,1,1,-1,0);

--Llamamos a Escribir Directo
insert into isys_querys_tx values ('12704',40,1,1,'select proc_prepara_graba_directo_almacen_12704(''$$__XMLCOMPLETO__$$'') as __xml__',0,0,0,1,1,-1,0);
insert into isys_querys_tx values ('12704',50,1,3,'Llamada a Escribir en Almacen',8015,0,0,0,0,60,60);
insert into isys_querys_tx values ('12704',60,1,1,'select proc_respuesta_almacen_12704(''$$__XMLCOMPLETO__$$'') as __xml__',0,0,0,1,1,-1,0);

CREATE or replace FUNCTION proc_prepara_graba_directo_almacen_12704(varchar) RETURNS varchar AS $$
DECLARE
    xml1        alias for $1;
        xml2    varchar;
    data1       varchar;
...
CREATE or replace FUNCTION proc_respuesta_almacen_12704(varchar) RETURNS varchar AS $$
DECLARE
    xml1        alias for $1;
    xml2        varchar;
        data1   varchar;
