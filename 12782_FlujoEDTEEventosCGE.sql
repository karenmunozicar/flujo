delete from isys_querys_tx where llave='12782';

-- Prepara llamada al AML
insert into isys_querys_tx values ('12782',5,1,1,'select proc_procesa_input_12782(''$$__XMLCOMPLETO__$$'') as __xml__',0,0,0,1,1,-1,0); 
insert into isys_querys_tx values ('12782',10,1,8,'Ejecuta Traza',12701,0,0,1,1,20,20);

--Se ejecuta en la Base del EDTE3
insert into isys_querys_tx values ('12782',20,12,1,'select public.sp_procesa_respuesta_cola_edte3(''$$__ID_DTE__$$'',''$$NOMBRE_COLA$$'',''$$RESPUESTA$$'')',0,0,0,1,1,0,0); 

CREATE or replace FUNCTION proc_procesa_input_12782(varchar) RETURNS varchar AS $$
DECLARE
    xml1        alias for $1;
        xml2    varchar;
BEGIN
